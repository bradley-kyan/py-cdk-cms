...
class CMSSite(App):
    def __init__(self, **kwargs):
        ...
        vpc_stack = VPCStack.VPCStack(self, "VPCStack")
        vpc = vpc_stack.vpc
        
        ecr_stack = ECRManagerStack.ECRManagerStack(self, "ECRStack")
        ecr_repo = ecr_stack.ecr_repo
        
        ecs_stack = ECSStack.ECSStack(self, "ECSStack", vpc=vpc, ecr_repository=ecr_repo)
