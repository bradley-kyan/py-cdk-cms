...
class ECSStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, vpc: ec2.Vpc, ecr_repository: ecr.Repository, **kwargs) -> None:
        ...
        container_image = ecs.ContainerImage.from_ecr_repository(ecr_repository, "latest")
